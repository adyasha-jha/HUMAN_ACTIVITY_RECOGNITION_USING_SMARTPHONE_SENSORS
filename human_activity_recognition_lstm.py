...
Original file is located at
    https://colab.research.google.com/drive/1lffjz1Lf9KYIrrZdV9IFGtDKynuCvgCd
...
"""**DOWNLOAD AND VISULAIZE DATA WITH LABELS**"""

# Download the UCF50 dataset (fixed command)
...
#using Keras to_categorical method to convert lavels into one-hot-encoding vectors
...
convlastm_model = create_convlstm_model()
...
plot_model(convlastm_model, to_file='convlstm_model_structure_plot.png', show_shapes=True, show_layer_names=True)

"""*COMPILE AND TRAIN THE MODEL*"""

# Construct the model before compiling
convlstm_model = create_convlstm_model()

# Now proceed with compile and fit
